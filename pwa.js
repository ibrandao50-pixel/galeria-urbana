...
window.addEventListener('beforeinstallprompt',event=>{event.preventDefault();installPrompt=event;if(SHOW_INSTALL_BUTTON)installButton.classList.remove('hidden')});
